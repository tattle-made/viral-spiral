defmodule ViralSpiralWeb.Router do
  ...
  import ViralSpiralWeb.UserAuth
  ...
  scope "/", ViralSpiralWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ViralSpiralWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ViralSpiralWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ViralSpiralWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ViralSpiralWeb do
    ...
    live_session :current_user,
      on_mount: [{ViralSpiralWeb.UserAuth, :mount_current_user}] do

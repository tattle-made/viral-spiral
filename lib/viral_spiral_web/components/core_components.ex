defmodule ViralSpiralWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-fuchsia-500 hover:bg-fuchsia-900 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ViralSpiralWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ViralSpiralWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  @doc """
  Renders a custom simple form for the home page.
  """
  attr :for, :any, required: true, doc: "the datastructure for the form"
  attr :as, :any, default: nil, doc: "the server side parameter to collect all input under"
  ...
  def simple_form_home(assigns) do
    ~H"""
    <.form :let={f} for={@for} as={@as} {@rest}>
  ...
  def popover(assigns) do
    ~H"""
    <div phx-hook="PopoverHook" id="popover">
